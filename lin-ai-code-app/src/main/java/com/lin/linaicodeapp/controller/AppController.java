...
import com.lin.linaicodeapp.ratelimter.annotation.RateLimit;
import com.lin.linaicodeapp.ratelimter.enums.RateLimitType;
...
public class AppController {
    ...
    public Flux<ServerSentEvent<String>> chatToGenCode(@RequestParam Long appId,
                                                       @RequestBody AppChatGenRequest chatGenRequest,
                                                       HttpServletRequest request) {
        String message = chatGenRequest == null ? null : chatGenRequest.getMessage();
        // 参数校验
     ...
     */
    @PostMapping("/update")
    @CacheEvict(value = "good_app_page", allEntries = true, condition = "#result.code == 0 && #result.data == true")
